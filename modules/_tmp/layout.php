...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="<?php echo _path_tmp('main/css/bootstrap.css')?>" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="<?php echo _path_tmp('main/css/style.css')?>"" rel="stylesheet" />
  <!-- responsive style -->
  <link href="<?php echo _path_tmp('main/css/responsive.css')?>" rel="stylesheet" />
</head>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="about.html">Customers</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="service.html"> Solutions </a>
                </li>
                <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-6 ">
                  <div class="detail_box">
                    ...
                    <p>
                      Providing Excellent Solutions to Mid-sized Scaling Business
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn-1"> Contact Us </a>
                      <a href="" class="btn-2"> Our Solutions </a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
