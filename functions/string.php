<?php
    ...
    function str_explode_trim($separator, $stringToArray) {
        $explodedString = explode($separator, $stringToArray);
        array_walk($explodedString, 'trim');
    ...
    function crop_string($string , $length = 20, $suffix = ' ...')
    {
